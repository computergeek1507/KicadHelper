...
partfields = set( ['Digi-Key_PN', 'LCSC', 'MPN'] )

columnset =  partfields     # union

# prepend an initial 'hard coded' list and put the enchillada into list 'columns'
columns = [ 'Value', 'Footprint'] + sorted(list(columnset))
...
for group in grouped:
    ...
    # from column 3 upwards, use the fieldnames to grab the data
